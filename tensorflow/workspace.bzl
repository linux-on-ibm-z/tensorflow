...
def tf_workspace(path_prefix="", tf_repo_name=""):
  ...
  native.new_http_archive(
      name = "eigen_archive",
      urls = [
#          "http://mirror.bazel.build/bitbucket.org/eigen/eigen/get/f3a22f35b044.tar.gz", #Upgrading eigen to build with vectorization support
          "https://bitbucket.org/eigen/eigen/get/940f20dd4eb3.tar.gz",
      ],
